...
namespace DataBase
{
    ...
    class Program
    {
        ...
        static void ReadFromFile()
        {
            ...
            Console.Write("Enter the name of database (without .txt extension) : ");
        ...
        static void SaveToFile()
        {
            if (PersonList.Count == 0)
            {
                Console.WriteLine("No databases to save.");
                return;
            }
        ...
        static void DeleteDatabaseFile()
        {
            ...
            string[] filePaths = Directory.GetFileSystemEntries("databases");
            ...
            Console.WriteLine("0 - Return to menu");
            Console.WriteLine("Enter the name of file to delete (without txt extension) .");
            while (true)
            {
                ...
                else if (File.Exists(@"databases\" + choice + ".txt"))
                {
                    File.Delete(@"databases\" + choice + ".txt");
                    break;
                }
                else
                {
                    Console.Write("Wrong name please try one more time : ");
                }
